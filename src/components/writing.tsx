...
const featuredArticles = articles.filter((a) => a.destacado)
    ...
    <section id="writing" className="px-6 lg:px-10 py-20 max-w-[1080px] mx-auto">
      ...
      >
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/writing" className="font-mono text-caption text-[#57534E] hover:text-[#FB923C] transition-colors duration-200">
            view all →
          </Link>
        </div>
      </motion.div>
