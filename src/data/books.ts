...
export const books: Book[] = [
  ...
  {
    id: 33,
    title: "Empieza con el porque",
    author: "Simon Sinek",
    note: "El Golden Circle: por que antes que que o como. Las marcas y lideres que inspiran empiezan por su proposito, no por su producto.",
    category: "business",
    rating: 5,
    year: "2025",
    destacado: false,
  },
  {
    ...
    title: "Atomic Habits",
    author: "James Clear",
    note: "Cambios del 1% que se acumulan en resultados extraordinarios. Sistemas por encima de metas: hacer los buenos habitos obvios, faciles y satisfactorios.",
    category: "life",
    rating: 5,
    year: "2025",
    destacado: false,
  },
  {
    ...
    note: "Dos sistemas de pensamiento, el intuitivo y el deliberado, y los sesgos que moldean nuestras decisiones. Clasico de la economia del comportamiento.",
    category: "business",
    rating: 5,
    year: "2025",
    destacado: false,
  },
  {
    ...
    note: "Educacion financiera contada como historia: la diferencia entre activos y pasivos, y por que la escuela no te ensena a manejar el dinero.",
    category: "business",
    rating: 5,
    year: "2025",
    destacado: false,
  },
  {
    ...
    note: "Salir del build trap: medir valor generado, no features entregadas. Organizarse alrededor de outcomes, con estrategia y el Product Kata.",
    category: "product",
    rating: 5,
    year: "2025",
    destacado: true,
